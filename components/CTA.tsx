      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <h2 className="text-4xl md:text-5xl font-black text-brand-white uppercase tracking-tighter hover-glow-brand cursor-default transition-all mb-4">
            Métrica.one <span className="text-brand-orange">no es para todos.</span>
          </h2>
          <div className="text-brand-white/60 max-w-2xl mx-auto space-y-4">
            <p>
              Diseñado exclusivamente para operadores que venden B2B, trabajan con tickets que importan y entienden el valor del pago por resultado.
            </p>
            <p className="text-brand-orange font-mono text-xs uppercase tracking-widest bg-brand-orange/5 py-2 rounded">
              Si buscas marketing convencional, este no es tu sistema.
            </p>
          </div>
        </div>
          ...
          <div className="lg:w-2/5 p-8 md:p-12 bg-brand-black/50 flex flex-col justify-center relative">
            ...
            <button className="w-full group relative overflow-hidden rounded bg-brand-orange text-brand-black font-bold text-lg uppercase tracking-widest py-4 hover:bg-white transition-all duration-300 shadow-[0_0_20px_rgba(249,115,22,0.4)] hover:shadow-[0_0_30px_rgba(255,255,255,0.4)] active:scale-95">
              <span className="relative z-10 flex items-center justify-center gap-2">
                Solicitar acceso <ArrowRight size={18} className="group-hover:translate-x-1 transition-transform" />
              </span>
              {/* Shine effect */}
